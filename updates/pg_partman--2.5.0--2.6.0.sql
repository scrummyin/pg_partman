-- Make initial C version of run_maintenance
-- Implement trigger_return_null option https://github.com/keithf4/pg_partman/issues/128 
    -- New parameter to create_parent() & create_sub_parent() so be sure to account for that in existing function calls
    -- TODO Add to documentation
    -- Create a subpartition test that looks for the data being put in the parent table to make sure it's working
-- Account for all new config columns when checking subpartition configuration consistency


-- TODO Add column to tables.sql
...
-- TODO REtain dropped function privileges
